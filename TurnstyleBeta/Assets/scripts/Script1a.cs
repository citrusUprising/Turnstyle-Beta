...
public class Script1a : MonoBehaviour
{
    ...
    void Start()
    {
        script[dialogueVarietyCount]=new overallDialogue("","","Apartment",
        new dialogueEntry[]{
        ...
        script[dialogueVarietyCount]=new overallDialogue("Amery","","Apartment",
        new dialogueEntry[]{
        ...
        script[dialogueVarietyCount]=new overallDialogue("Amery","Jade","Apartment",
        new dialogueEntry[]{
        ...
        script[dialogueVarietyCount]=new overallDialogue("Amery","Beverly","Apartment",
        new dialogueEntry[]{
        ...
        script[dialogueVarietyCount]=new overallDialogue("Amery","Seraphim","Apartment",
        new dialogueEntry[]{
        ...
        script[dialogueVarietyCount]=new overallDialogue("","Seraphim","Apartment",
        new dialogueEntry[]{
        ...
        script[dialogueVarietyCount]=new overallDialogue("Koralie","Seraphim","Apartment",
        new dialogueEntry[]{
        ...
        script[dialogueVarietyCount]=new overallDialogue("Koralie","Jade","Apartment",
        new dialogueEntry[]{
        ...
        script[dialogueVarietyCount]=new overallDialogue("Koralie","Beverly","Apartment",
        new dialogueEntry[]{
